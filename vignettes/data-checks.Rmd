...
test <- col_check("Perf_Lvl", dataset, val_check, values = c("Basic", "Intermediate", "Advanced"))

test <- col_check("Perf_Lvl", dataset, fun = function(x){
  x %in% c("Basic", "Intermediate", "Advanced")
})
